...
public class DataSample1 {
	
	
	public ArrayList<String> getData(String testcase) throws FileNotFoundException {
		// Creating array list for future use.
				...
				for(int i =0; i<sheets; i++) {
					...
					while(rows.hasNext()) {
						...
						if(r.getCell(column).getStringCellValue().equalsIgnoreCase("Acceleratornew")){
